...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" data-spy="affix" data-offset-top="0">
        <div class="container">
            <a class="navbar-brand" href="#"><img src= "{{ asset('template/imgs/ramen.jpg') }}" style="padding: 5px"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto align-items-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('showRamen.admin') }}">Manage Ramen</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('showQueue.admin') }}">Order Queue</a>
                    </li>                   
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('profile.admin') }}">Profile</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('history.admin') }}">History</a>
                    </li>
                    <li class="nav-item">
